    ...
    public class UserActivityHook
    {
        ...
        public void Start(bool InstallMouseHook, bool InstallKeyboardHook)
        {
            ...
            if (hMouseHook == 0 && InstallMouseHook)
            {
				...
				IntPtr ptr = Marshal.GetHINSTANCE(
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
			...
			if (handled)
			{
				//Debug.WriteLine("KeyboardHookProc: Handled.");
				//return CallNextHookEx(hKeyboardHook, -1, wParam, lParam);
				//return 0;
				//return -1;
				return 1;
			}
			else
			{
				...
				{
					Debug.WriteLine("An exception occurred on a keyboard hook proc: " + ex.ToString());
					return -1;
				}
			}
        }
